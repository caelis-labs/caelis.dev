...
document.addEventListener('DOMContentLoaded', () => {
  const translations = {
    en: {
      ...
      tui: {
        eyebrow: 'WORK AT TERMINAL SPEED',
        title: 'Everything you need, one keystroke away.',
        body: 'Find commands, Skills, and files without leaving the composer. Long-running work stays visible without taking over the conversation.',
        detail1: 'Connect providers and agents from the welcome screen',
        detail2: 'Complete commands, Skills, and file paths in place',
        detail3: 'Resume sessions and follow long-running work when you need it',
      },
      surfaces: {
    ...
    zh: {
      ...
      tui: {
        eyebrow: '保持终端节奏',
        title: '所需能力<br>一步即达',
        body: '命令、Skills 与文件都能在输入框中快速找到；长任务保持可见，也不会打断当前对话。',
        detail1: '从欢迎界面连接模型服务与 Agent',
        detail2: '在输入框内补全命令、Skills 与文件路径',
        detail3: '随时恢复 Session，并按需查看长任务进度',
      },
      surfaces: {
