...
[English](/docs/caelis-bot/reference/install/) · [简体中文](https://github.com/caelis-labs/caelis-bot/blob/0842c59ac7ab007b67f7d25a51129b87d37bd60e/docs/install.zh-CN.md)
...
The app uses an existing compatible local Codex App Server or discovers a local Codex CLI. If automatic discovery fails, select its executable in **Settings → Runtime → Codex**. Installing or opening Codex Desktop alone does not guarantee an accessible runtime. The Bot does not silently install Codex or log in for you. See [runtime compatibility](https://github.com/caelis-labs/caelis-bot/blob/0842c59ac7ab007b67f7d25a51129b87d37bd60e/docs/codex-compatibility.md).
