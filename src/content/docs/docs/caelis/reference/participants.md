...
[external ACP contract](/docs/caelis/reference/external-acp-agents/#input-and-collaborator-sessions)
...
agents; see [connection and endpoint setup](/docs/caelis/reference/external-acp-agents/#connect).
...
to be idle. See the [delivery contract](/docs/caelis/reference/external-acp-agents/#input-and-collaborator-sessions)
