...
[English](/zh-cn/docs/caelis-bot/reference/install/) · [简体中文](https://github.com/caelis-labs/caelis-bot/blob/0842c59ac7ab007b67f7d25a51129b87d37bd60e/docs/install.zh-CN.md)
...
应用优先连接可用的本机 Codex App Server，否则自动发现 Codex CLI。若发现失败，在“设置 → 接入运行时 → Codex”中指定可执行文件。仅安装或打开 Codex Desktop 不保证存在可连接的入口；Bot 不会静默安装 Codex，也不代替用户登录。详见[运行时兼容性](https://github.com/caelis-labs/caelis-bot/blob/0842c59ac7ab007b67f7d25a51129b87d37bd60e/docs/codex-compatibility.md)。
