...
sourcePath: "docs/memory-v0.6-facts.md"
generated: true
editUrl: false
sidebar: {"order":20}
---
...
onsets and adoption remain unknown after [migration](/zh-cn/docs/memory/reference/migration/).
...
| change | genuine long-term change | confirmed target + expected revision + explicit valid\_from; prior revision ends at that instant for historical adoption |
| exception | finite temporary override | confirmed same-key target + expected revision + valid\_from/valid\_until; separate linked Record; base resumes after expiry |
...
structured heads. [Steward](https://github.com/caelis-labs/memory/blob/847c4699f8e59cf3ea53e16df0726a4420b13c80/docs/memory-v0.6-steward.md) owns bounded relevant context,
...
See [governance](https://github.com/caelis-labs/memory/blob/847c4699f8e59cf3ea53e16df0726a4420b13c80/docs/memory-v0.6-governance.md) for barrier/cleanup completion and
