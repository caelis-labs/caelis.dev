...
sourcePath: "docs/external-acp-agents.md"
generated: true
editUrl: false
sidebar: {"order":20}
---
...
For collaboration setup and workspace controls, see [Participants](/zh-cn/docs/caelis/reference/participants/).
Layer ownership lives in [Architecture](https://github.com/caelis-labs/caelis/blob/f136ebaeb46608a69bf7732af57bb2f2a2382756/docs/architecture.md).
...
* **Install agy\_acp\_server.par** (`.exe` on Windows) checks the official
